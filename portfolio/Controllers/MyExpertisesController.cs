...
namespace portfolio.Controllers
{
    public class MyExpertisesController : Controller
    {
        ...
        public MyExpertisesController(portfolioContext context)
        {
            _context = context;
        }
        ...
        {
            var portfolioContext = _context.MyExpertise.Include(m => m.Person);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,PersonId")] MyExpertise myExpertise)
        {
            ...
            ViewData["PersonId"] = new SelectList(_context.PersonalInfo, "Id", "Id", myExpertise.PersonId);
            return View(myExpertise);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'portfolioContext.MyExpertise'  is null.");
            }
            var myExpertise = await _context.MyExpertise.FindAsync(id);
            if (myExpertise != null)
            {
